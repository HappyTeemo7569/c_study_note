...
int main()
{
	...
	//     RSA_Initialize();
	//RSA_Encrypt();
	Ciphertext[100] = "UpdateInfo = +V0 / ydSkW8igBRZonQRqycCkT8i8BQpoiQR + \
              ycykQ8iIBT5otQRCyfikd8iEBTJooQRWyeSka8iQBSZorQRayZCkH8jsBVpo2QQuyZykE8j4BU5i9ERYxrz2ZZmeXjMpi0gij4b1HtauQQgtl19 + \
              htT6W4eoQR4nnVpqhti4V8hcBepsYUqWkiz / o4dQW + YndUDGwny24toIVe13ZhvRkhD + j5doTg ==\
              ";
	RSA_Decrypt();
	system("pause");
	return 0;
